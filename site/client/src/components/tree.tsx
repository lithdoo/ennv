...
export function FolderTree({
    ...
    target: EnFile | null,
    queryFolderChildren: (stat?: EnFile) => Promise<EnFile[]>
    selectFolder: EnFile | null,
    setSelectFolder: (folder: EnFile | null) => void,
}) {
    ...
    const load = async (parent?: EnFile, pid?: string) => {
